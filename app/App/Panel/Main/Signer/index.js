...
class Signer extends React.Component {
    ...
    return (
      <div className="signerType">
        ...
        <div
          ...
          style={inSettings ? { opacity: 1, transitionDelay: '0s' } : { opacity: 1, transitionDelay: '0.2s' }}
          onMouseDown={e => {
            e.stopPropagation()
        ...
        <div className="accountList" onMouseDown={e => e.stopPropagation()}>
          <div className="accountListItems">
            {this.store('main.accounts', this.props.id, 'addresses')
              ...
              .map((a, i) => {
                i = startIndex + i
                const balance = this.store('balances', a, NATIVE)
                return (
                  <div
                    key={i}
                  ...
                  >
                    ...
                    <div className="accountListItemBalance">
                      {'🌸' + (balance === undefined ? '-.----' : parseFloat(balance).toFixed(4))}
                    </div>
                  </div>
                )
              })}
  ...
  renderStatus() {
    ...
    const pollen = this.store('balances', address, NATIVE)
    const honey = this.store('balances', address, 'honey')
          ...
          <div className="signerAccounts" style={{ width: '100%' }}>
            <div key={address + currentIndex} className="signerAccount" style={{ minWidth: `calc(100%)` }}>
              ...
              <div className="signerInfo">
                ...
                <div className="signerBalance">
                  <span className="signerBalanceCurrency">{'🍯'}</span>
                  {honey === undefined ? '-.------' : parseFloat(honey).toFixed(6)}
                </div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        >
          <div className="signerContainer" style={current ? { height: '100%' } : {}}>
            ...
            {current ? (
              <div className="signerMid" style={open ? { top: '265px' } : { pointerEvents: 'none' }}>
